...
<body>
  ...
  <div class="hero">
    ...
    <div class="right">
      <img src="./images/junniee.png" alt="" />
    </div>
  </div>
  ...
  <section class="section promotion">
    ...
    <div class="promotion-layout container">
      <div class="promotion-item">
        <img src="./images/tp-tshi.jpg" alt="" />
  ...
  <section class="section products">
    ...
    <div class="product-layout">
      ...
      <div class="product">
        ...
        <div class="bottom">
          <a href="">WLKJN Purse</a>

          <div class="price">
            <span>₱110.00</span>
            <span class="cancel">₱200.00</span>
          </div>
        </div>
      </div>
        ...
        <div class="glide__track" data-glide-el="track">
          <ul class="glide__slides">
            <li class="glide__slide">
              <img src="./images/boss1-logo.png" alt="">
            </li>
            <li class="glide__slide">
              <img src="./images/cong-logo.png" alt="">
            </li>
            <li class="glide__slide">
              <img src="./images/giyang-logo.png" alt="">
            </li>
            <li class="glide__slide">
              <img src="./images/wlkjn-logo.png" alt="">
            </li>
            <li class="glide__slide">
